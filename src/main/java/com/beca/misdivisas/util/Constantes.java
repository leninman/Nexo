...
public final class Constantes {
	...
	public static final String CUERPO_CORREO_SOLICITUD_PROCESADA_AUTORIZADO = "Le informamos que en fecha {0} ha sido procesada la solicitud de retiro identificada con el Carta Porte <b>{1}</b>. <br/><br/> Esta solicitud fue generada para usted, por la empresa {2}, quienes le autorizan a presentarse el día {3} en nuestra agencia {4}, desde las 09:00 a.m. hasta las 12:00 p.m. <br/><br/> Recuerde traer sus documentos de identificación y su teléfono celular.";
